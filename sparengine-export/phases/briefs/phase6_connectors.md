...
**Reference files:**
- `references/csv_and_ocr.md` (entities, sections — address_block, certification_statement)
- `references/data_quality_rules.md` (organisation name normalisation, CAMP-as-concept rule)
