...
**Reference files:**
- `references/investigation_discipline.md` — the same 9 strategies, applied with fresh state and full corpus context
...
| 9 | **oem_typical** | known OEM patterns from `references/data_quality_rules.md` (e.g. P&WC LLPs are typically grouped on `engine_llp_status_sheet` documents) |
